...
int main (int argc, char * argv[]) {
	...
	*/
	...
	sprintf(fileName, "SingularValues/CudaDevice/OneSidedParallelShared/Singular Values Cuda Device %dx%d.txt", rows, cols);
	openFile(&fp, fileName, "w");
	...
	sprintf(fileName, "Time/CudaDevice/OneSidedParallelShared/Time %dx%d.txt", rows, cols);
	openFile(&fp, fileName, "w");
